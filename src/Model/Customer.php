...
class Customer implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['billingPostalCode'] === null) {
            $invalid_properties[] = "'billingPostalCode' can't be null";
        }
