...
class DefaultApi
{
     ...
     */
    public function brightwriteControllerStatus()
    {
        list($response, $statusCode, $httpHeader) = $this->brightwriteControllerStatusWithHttpInfo ();
        return $response; 
    }


    /**
     * brightwriteControllerStatusWithHttpInfo
     *
     * Health check endpoint
     *
     ...
     * @throws \BrightWrite\ApiException on non-2xx response
     */
    public function brightwriteControllerStatusWithHttpInfo()
    {
