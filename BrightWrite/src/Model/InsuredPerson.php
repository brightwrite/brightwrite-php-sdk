...
class InsuredPerson implements ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['yearOfBirth']) && ($this->container['yearOfBirth'] > 2040)) {
            $invalid_properties[] = "invalid value for 'yearOfBirth', must be smaller than or equal to 2040.";
        }
    ...
    public function valid()
    {
        ...
        if ($this->container['yearOfBirth'] > 2040) {
            return false;
        }
    ...
    public function setYearOfBirth($yearOfBirth)
    {
        ...
        if (!is_null($yearOfBirth) && ($yearOfBirth > 2040)) {
            throw new \InvalidArgumentException('invalid value for $yearOfBirth when calling InsuredPerson., must be smaller than or equal to 2040.');
        }
