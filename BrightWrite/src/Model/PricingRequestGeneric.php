...
class PricingRequestGeneric implements ArrayAccess
{
    ...
    protected static $setters = [
        ...
        'technicalPrice' => 'setTechnicalPrice',
    ...
    protected static $getters = [
        ...
        'technicalPrice' => 'getTechnicalPrice',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['technicalPrice'] = isset($data['technicalPrice']) ? $data['technicalPrice'] : null;
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['technicalPrice'] === null) {
            $invalid_properties[] = "'technicalPrice' can't be null";
        }
    ...
    /**
     * Sets currency
     * @param string $currency Currency used for the technical price. Three character ISO 4217.
     * @return $this
     */
     ...
     * @return double
     */
    public function getTechnicalPrice()
    {
        return $this->container['technicalPrice'];
    }

    /**
     * Sets technicalPrice
     * @param double $technicalPrice Pricing calculated by the underwriter without regard to yield calculations.
     * @return $this
     */
    public function setTechnicalPrice($technicalPrice)
    {
        $this->container['technicalPrice'] = $technicalPrice;
